...
const ak = '6xkgmLbvNnQ3WinYsM81KEkvVndYPdAhepTxzam8'
const sk = 'r4cvVSDeUTJ6UP6FCGUJpSOi7MkcA-XP2a4ANgjp'
...
function getToken() {
  ...
  let putPolicy = {
    scope: bucket,
    deadline: parseInt(Date.now() / 1000) + 3060000
  }

  const setPolicy = JSON.stringify(putPolicy)

  const encoded = base64encode(utf16to8(setPolicy))
